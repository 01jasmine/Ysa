...
<body  onload="ccgen();"style="background-image: url('cute.jpeg');background-repeat: no-repeat;
  ...
  background-size: 100% 100%;">
	...
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<img class="rounded-circle" src="cute9.jpeg" width="100" height="100" style="margin-top: 10px;" onclick="modalCCGEN();">
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
			...
			<div class="col-md-8">
				<form>
					<div class="form-group">
						<label for="cards" style="color: skyblue; margin-left: 20px">Generated Cards</label>
						<textarea class="form-control" style="background: transparent;color: pink;overflow:hidden" id="cards" rows="5" placeholder="xxxxxxxxxxxxxxxx|xx|xxxx|xxx" required></textarea>
					</div>
					<div class="form-group">
						<label for="sk" style="color: skyblue; margin-left: 20px">API</label>
						<select class="form-control" id="api" style="background: transparent;color: pink;">
					...
					<div class="form-group">
						<label for="sk" style="color: skyblue; margin-left: 20px">Stripe Secret Key (SK)</label>
						<div class="input-group mb-3">
							<input type="text" class="form-control" style="background: transparent;color: pink;" id="sk" aria-describedby="sk" placeholder="sk_live_xxxxxxxxxxxxxxxxxx">
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p class="badge badge-dark"><h6><span style="color:#ff5000">❣️</span><span style="color:#ffa100">L</span><span style="color:#fff100">i</span><span style="color:#bbff00">L</span><span style="color:#6bff00">❣️</span><span style="color:#1aff00">S</span><span style="color:#00ff86">A</span><span style="color:#00ffd6">i</span><span style="color:#0086ff">N</span><span style="color:#0035ff">T</span><span style="color:#1a00ff">❣️</h6></p></center></div>
	</div>
			...
			<div class="modal-content" style="background: transparent;">
				<div class="modal-body" style="background: #212121">
					<center style="margin-bottom: 20px">
						<img class="rounded-circle" src="cute1.jpeg" width="200" height="200" style="margin-top: 10px;margin-bottom: 20px;" >
		...
		<div class="modal-dialog  modal-dialog-centered">
			<div class="modal-content" style="background: transparent">
				<div class="modal-body" style="background: transparent">
					<center style="margin-bottom: 20px">
						<img class="rounded-circle" src="cute2.jpeg" width="200" height="200" style="margin-top: 10px;margin-bottom: 20px;" >
...
<center>
<audio controls>
  <source src="cuppy.mp3" type="audio/mpeg">
  </audio>
</center>
<style>
